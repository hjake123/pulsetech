...
public class PulsetechPonderPlugin implements PonderPlugin {
    ...
    public void registerScenes(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        ...
        helper.addStoryBoard(ModBlocks.CANNON.getId(), Pulsetech.location("datacell/scanner_pos"), Storyboards::dataCellScanner);
        ...
        helper.addStoryBoard(ModBlocks.ORB.getId(), Pulsetech.location("datacell/scanner_pos"), Storyboards::dataCellScanner);
